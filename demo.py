#!/usr/bin/python
import sys
import os from binascii
import b2a_hexpdf - miner requirements
...
def with_pdf(pdf_doc, fn, pdf_pwd, *args):
    ...
    try:
        ...
        def _parse_toc(doc):
            """With an open PDFDocument object, get the table of contents (toc) data   [this is a higher-order function to be passed to with_pdf()]"""
            toc = [] try:
